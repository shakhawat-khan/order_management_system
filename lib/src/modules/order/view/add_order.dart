                          ...
                          children: [
                                  ...
                                  child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                              ...
                                              width: 0.5)),
                                      child:
                                          Image.asset("assets/ic-upload.png")),
                                ),
                                SizedBox(
                                  width: 10,
                                ),
                                ref.watch(pickImageProvider).length > 0
                                    ? Expanded(
                                        child: Container(
                                          child: Wrap(
                                            runSpacing: 2,
                            ...
                            Container(
                              ...
                              child: DropdownButton(
                                isExpanded: true,
                                icon: Image.asset(
                                    "assets/ic-downarrow-dropdown.png"),
                                underline: SizedBox(),
                                hint: Text(
                                  'Category Name',
                                  style: kTextStylePoppinsTitel,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  TextField(
                                    ...
                                    controller: ref.watch(
                                        textControllerProvider('start_date')),
                                ...
                                children: [
                                  ...
                                  TextField(
                                    style: GoogleFonts.poppins(
                                        ...
                                        fontWeight: FontWeight.w300),
                                    controller: ref.watch(
                                        textControllerProvider('end_date')),
                                    decoration: InputDecoration(
                                        contentPadding:
                                            EdgeInsets.only(left: 15),
                                        enabledBorder: const OutlineInputBorder(
                                ...
                                child: DecoratedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      if (ref.read(pickImageProvider).length >
                                          0) {
                                        uploadImage(ref.read(pickImageProvider))
                                            .then((value) {
                                          print(
                                              "the total array size is ${value}");
                                          var data = Orders(
                                              orderId: '',
                                              allocatedJob:
                                                  ref.read(dropdown2Provider)!,
                                              categoryName:
                                                  ref.read(dropdown1Provider)!,
                                              ...
                                              details: ref
                                                  ...
                                                  .text,
                                              startDate:
                                                  '${ref.read(textControllerProvider('start_date')).text}',
                                              endDate:
                                                  '${ref.read(textControllerProvider('end_date')).text}',
                                              imagePath: 'test',
                                              rawMaterial: ref
                                                  .read(textControllerProvider(
                                                    'order_rawMaterial',
